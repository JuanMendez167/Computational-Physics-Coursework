...
# Replace with the following line for Halloween!
#a,=ax.plot([],[], marker='$\U0001F608$', linestyle='', ms=20, c='green')

# Full list of compatible emoji can be found at 
# https://www.compart.com/en/unicode/block/U+1F600
# You'll need to replace "+" with "000"
