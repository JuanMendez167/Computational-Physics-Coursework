...
# ✔
# Good reasoning for choice of dt

# For the error analysis, the results from your Euler2 
# should improve upon Euler1, but in your result
# Euler2 looks very different.
# This is because to get xEuler2, you called the move_Euler()
# function, which uses dt=0.01 (a global variable),
# instead of the dt2=0.005 you set up and intended to use here.
# So overall while I appreciate the effort to 
# create a separate simulation for each dt, this 
# can also lead to unintended troubles if we're 
# not carefull. Here it's okay to manually change dt 
# in two separate runs and
